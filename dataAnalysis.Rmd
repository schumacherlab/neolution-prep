...
############# This means that all instances of 'regexPatterns$snp_identifier', should be changed to 'regexPatterns$gs_identifier' ##################################
...
dna_vaf_summary = data.table(patient_id = sapply(varcontext_output, function(dt) dt[, unique(patient_id)]),
                             ...
                             median_dna_vaf = sapply(varcontext_output, function(dt) round(x = median(dt[!grepl(regexPatterns$snp_identifier, variant_id), dna_vaf], na.rm = TRUE), digits = 2)))
...
ggplot(data = all_variants[!grepl(regexPatterns$snp_identifier, variant_id)], 
